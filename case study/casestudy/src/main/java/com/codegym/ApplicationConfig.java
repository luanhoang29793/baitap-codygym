...
import com.codegym.service.ImagesServiceImpl;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/case");
        dataSource.setUsername( "root" );
        dataSource.setPassword( "Lluan123" );
        return dataSource;
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry
                .addResourceHandler("/theme/**")
                .addResourceLocations("/theme/");
        registry.addResourceHandler("/images/**")
                .addResourceLocations("/theme/images/");
        registry
                .addResourceHandler("/js/**")
                .addResourceLocations("/theme/js");
        registry
